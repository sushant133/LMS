...
export const COLLEGE_STAFF_TABS: Array<{ id: CollegeStaffTabId; label: string; category?: CollegeStaffCategory }> = [
  ...
  { id: "transport", label: "Drivers / Transport Staff", category: "TRANSPORT" },
  { id: "it", label: "IT Staff", category: "IT_STAFF" },
  { id: "other", label: "Other Staff", category: "OTHER" }
];

export const isGenericStaffTab = (tab: CollegeStaffTabId): tab is Exclude<
  CollegeStaffTabId,
