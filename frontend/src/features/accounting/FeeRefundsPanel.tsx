...
export const FeeRefundsPanel = ({ canWrite }: { canWrite: boolean }) => {
  ...
  const create = useMutation({
    mutationFn: (payload: FeeRefundInput) =>
          ...
          <CardContent>
            <form
              ...
              onSubmit={(e) => {
                ...
                if (!parsed.success)
                  return toast.error(
                    parsed.error.issues[0]?.message ?? "Invalid refund",
                  );
            ...
            >
              <FormField label="Student">
                <Select
                  ...
                  onChange={(e) =>
                    setForm((c) => ({ ...c, studentId: e.target.value }))
                  }
                >
                  ...
                  onChange={(e) =>
                    setForm((c) => ({
                      ...
                      paymentMethod: e.target
                        .value as FeeRefundInput["paymentMethod"],
                    }))
                  }
                >
