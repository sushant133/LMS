...
export const TimetablePrintView = ({
  ...
  <div
    id={printId}
    className="timetable-print-sheet hidden print:block space-y-4 bg-white p-6 text-black"
    style={{
  ...
  >
    <header className="border-b-2 border-black pb-4 text-center text-black">
      {meta.logoUrl ? (
        <img
          src={meta.logoUrl}
          alt=""
      ...
      {meta.collegeNameNp ? (
        <p className="text-sm font-medium text-black">{meta.collegeNameNp}</p>
      ) : null}
      {meta.collegeAddress ? (
        <p className="mt-1 text-sm font-medium text-black">{meta.collegeAddress}</p>
      ) : null}
      <p className="mt-2 text-lg font-bold text-black">Weekly Class Timetable</p>
      <p className="text-sm font-semibold text-black">{meta.viewTitle}</p>
      <div className="mt-2 flex flex-wrap justify-center gap-x-4 gap-y-1 text-xs font-semibold text-black">
    ...
    <footer className="mt-10 grid grid-cols-3 gap-6 pt-8 text-center text-xs text-black">
      <div>
        <div className="mx-auto mb-8 h-12 border-b border-black" />
      ...
      <div>
        <div className="mx-auto mb-8 flex h-12 items-end justify-center">
          <span className="rounded-full border border-dashed border-black px-4 py-2 text-[10px] font-medium text-black">
            Optional Stamp
          </span>
        </div>
        <p className="font-bold text-black">Official Seal</p>
      </div>
      <div>
        <div className="mx-auto mb-8 h-12 border-b border-black" />
