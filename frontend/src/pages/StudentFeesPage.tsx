...
export const StudentFeesPage = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Fee History" description="View your complete payment history and outstanding dues." />
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent className="text-2xl font-semibold text-brand-600">{formatCurrencyNpr(history.totalPaidNpr)}</CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
