...
export const NepaliDateField = ({ value, onChange, placeholder }: NepaliDateFieldProps) => (
  <div className="rounded-xl border border-slate-300 bg-white px-3 py-2 focus-within:border-emerald-500">
    <Picker
      language="en"
