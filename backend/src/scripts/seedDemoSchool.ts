...
import { DEFAULT_ACADEMIC_YEAR_BS, DEFAULT_LAB_CATEGORIES } from "@nepal-school-erp/shared";
...
import { calculateResultGrade, getOffsetBsDate, getTodayBs } from "../utils/nepaliDate";
import { defaultSchoolAddress, buildSchoolSettingsPayload } from "../utils/schoolDefaults";
import { withTransaction } from "../utils/transaction";
import { DEMO_PASSWORD, DEMO_SCHOOL_CODE, demoCredentials, printDemoCredentials } from "./demoCredentials";
...
const seedDemoSchool = async (): Promise<void> => {
  ...
  await withTransaction(async (session) => {
    ...
    const { AssignmentComment } = await import("../models/AssignmentComment");
